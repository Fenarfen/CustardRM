...
namespace CustardRM
{
    public partial class ReviewSentimentAnalysisModel
    {
        public const string RetrainFilePath =  @"C:\Users\lewis\source\repos\CustardRM\AI\TrainingData\SentimentAnalysisTrainingData.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Sentiment",inputColumnName:@"Sentiment",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Sentiment", sentence1ColumnName: @"Review"))      
